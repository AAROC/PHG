  ...
  $( function() {
	...
	<script type="text/javascript">
		...
		$(document).ready(function() {
			var config = {
    apiKey: "AIzaSyBJ_qgrmP7k7ABJOo8pelvfvg7fnu9rLrg",
    authDomain: "sci-gaia-phg.firebaseapp.com",
    databaseURL: "https://sci-gaia-phg.firebaseio.com",
    storageBucket: "sci-gaia-phg.appspot.com",
    messagingSenderId: "822896374854"
  };
    ...
    var database = firebase.database();
				...
				function map_initialize() {
					...
					google.maps.event.addListener(map, 'rightclick', function(event) {
						...
						writeUserData(event.latLng.lat().toString(),event.latLng.lng().toString());
...
var a = new Date(dateTime );
  ...
  firebase.database().ref('reports/'+time ).set({
    latitude: lat,
    longitude: long,
    serverity : "3"
  });
